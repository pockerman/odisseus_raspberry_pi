...
from odisseus.confing import USE_MULTIPROCESSING
from odisseus.config import INDEX_DISPLAY_TEMPLATE_NAME
from odisseus.config import CAMERA_SLEEP_TIME
from odisseus.config import DEBUG
from odisseus.config import HOST
from odisseus.config import PORT
from odisseus.config import NEEDED_CAMERA_ROTATION
from odisseus.config import display_queue
from odisseus.config import control_queue
