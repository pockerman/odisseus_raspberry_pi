...
class Propulsion:
    ...
    def setup(self):
        ...
        if self._params.in_pin_1_motor_2 is not None and \
            ...
            self._GPIO.setup(self._params.in_pin_1_motor_2, self._GPIO.OUT)
            self._GPIO.setup(self._params.in_pin_2_motor_2, self._GPIO.OUT)
            self._GPIO.setup(self._params.en_pin_motor_2,  self._GPIO.OUT)
    ...
    def forward(self, speed, **kwargs):
        ...
        p2 = self._GPIO.PWM(self._params.en_pin_motor_2, 1000)
        p2.start(speed)

        self._GPIO.output(self._params.in_pin_1_motor_2, self._GPIO.HIGH)
        self._GPIO.output(self._params.in_pin_2_motor_2, self._GPIO.LOW)
    ...
    def backward(self, speed, **kwargs):
        ...
        p2 = self._GPIO.PWM(self._params.en_pin_motor_2, 1000)
        p2.start(speed)
        self._GPIO.output(self._params.in_pin_1_motor_2, self._GPIO.LOW)
        self._GPIO.output(self._params.in_pin_2_motor_2, self._GPIO.HIGH)
